...
// Custom code #####################################################
function swiperStop(){swiper.autoplay.stop()}function swiperStart(){swiper.autoplay.start()}const swiperElement=document.querySelector(".swiper"),defaultInterval=9e3,swiperInterval=parseInt(swiperElement.getAttribute("data-interval"),10)||defaultInterval,swiper=new Swiper(swiperElement,{slidesPerView:1,spaceBetween:15,loop:!0,keyboard:{enabled:!0},mousewheel:{invert:!1},autoplay:{delay:swiperInterval,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0},on:{autoplayTimeLeft(e,t,r){const n=Math.max(0,Math.min(r,1)),a=Math.round(100*(1-n)),i=document.querySelector(".swiper-pagination-bullet-active");i&&i.style.setProperty("--progress",`${a}%`)}}});swiperElement.addEventListener("touchstart",swiperStop),swiperElement.addEventListener("mouseenter",swiperStop),swiperElement.addEventListener("touchend",swiperStart),swiperElement.addEventListener("mouseleave",swiperStart);